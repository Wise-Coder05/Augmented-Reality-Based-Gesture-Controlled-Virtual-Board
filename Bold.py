...
def drawAll(img, buttonList):
    for button in buttonList:
        ...
        cv2.rectangle(img, button.pos, (x + w, y + h), (50, 0, 50), cv2.FILLED)
...
def drawAll(img, buttonList):
    ...
    for button in buttonList:
        ...
        cv2.rectangle(imgNew, button.pos, (x + w, y + h), (50, 0, 50), cv2.FILLED)
...
while True:
    ...
    cv2.rectangle(img, (50, 350), (700, 450), (100, 0, 100), cv2.FILLED)
